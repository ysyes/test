...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        value: function (val) {
            ...
            var perVal = Math.round(((val - minVal) * 100 / (maxVal - minVal)) * 100) / 100, //percentage value tp two decimal precision
                dispVal = indOption.percentage ? perVal + indOption.unit : this.formatter(val); //formatted value
    ...
    radialIndicator.defaults = {
        ...
        fontFamily: '微软雅黑', //defines font family
